  ...
  try {
    const response = await axios.put(
      "/users/updateusers",
      {
        ...
        can_open: newCanOpenStatus,
        idfinger: newIdfinger,
      },
      { headers: { Authorization: `Bearer ${token}` } }
    );
